    ...
    Object.keys(counts).length === 0 ? (
      ...
      <div className={styles.areaCountsComponent}>
        ...
        <div className={styles.areaCountsContainer}>
          ...
          <div className={styles.areaCount} onClick={()=>onClickCount('전북')}><div className={styles.areaName}>전라북도</div> <div className={styles.count}>{counts['충남'] ? counts['충남'] : '0'}</div></div>
          <div className={styles.areaCount} onClick={()=>onClickCount('전남')}><div className={styles.areaName}>전라남도</div> <div className={styles.count}>{counts['충남'] ? counts['충남'] : '0'}</div></div>
